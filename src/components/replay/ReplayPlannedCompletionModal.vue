        ...
        >
          <section v-if="!upperCollapsed" data-testid="completion-upper-pane" class="replay-completion-upper-pane">
            ...
            <div class="replay-completion-range-fields">
              ...
              <div class="replay-completion-grouping-switch replay-completion-replay-type-switch replay-completion-filter-group" role="group" aria-label="计划完成情况回放交易类型" data-testid="completion-replay-type-switch">
              ...
              <div class="replay-completion-grouping-switch replay-completion-filter-group" role="group" aria-label="计划完成情况统计分组口径" data-testid="completion-grouping-switch">
